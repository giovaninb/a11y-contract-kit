...
- [Exportação de correções](FIX_EXPORT.md) — cherry-pick de fixes (UIKit, Framework, SwiftUI)
...
| `A11yContractReporter` | Markdown, JSON, Sonar, SARIF, JUnit, exportação cherry-pick |
